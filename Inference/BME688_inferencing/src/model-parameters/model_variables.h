...
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_3_axes[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
const uint32_t ei_dsp_config_3_axes_size = 8;
...
const ei_impulse_t impulse_714970_0 = {
    .project_id = 714970,
    .project_owner = "university of west attica",
    .project_name = "BME688",
    .impulse_id = 1,
    ...
    .fusion_string = "Sensor 0 + Sensor 1 + Sensor 2 + Sensor 3 + Sensor 4 + Sensor 5 + Sensor 6 + Sensor 7",
    .slice_size = (1/4),
...
ei_impulse_handle_t impulse_handle_714970_0 = ei_impulse_handle_t( &impulse_714970_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_714970_0;
